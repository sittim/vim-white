...
if !exists('g:white_allow_italics')
  let g:white_allow_italics = 0
endif
...
if has('gui_running') || &t_Co == 88 || &t_Co == 256
  ...
  fun <sid>X(group, fg, bg, attr)
    let l:attr = a:attr
    if g:white_allow_italics == 0 && l:attr ==? 'italic'
        let l:attr= 'none'
    endif
...
"}}}
  " Public API --------------------------------------------------------------{{{
  function! white#highlight(group, fg, bg, attr)
